    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-10 margin-top-1">
                <span class="d-block mb-3 caption" data-aos="fade-up">Lo que debes de saber</span>
                <h1 class="d-block mb-4" data-aos="fade-up" data-aos-delay="100">FAQ</h1>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row align-items-stretch program">
                    <div class="col-12 border-top border-bottom py-5" data-aos="fade" data-aos-delay="200">
                        <div class="row align-items-stretch">
                            <div class="col-md-12">
                                <h2 class="text-white">¿Cuándo será el evento?</h2>
                                <span>14 de noviembre del 2019</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 border-bottom py-5" data-aos="fade" data-aos-delay="400">
                        <div class="row align-items-stretch">
                            <div class="col-md-12">
                                <h2 class="text-white">¿Me puedo inscribir si soy ajeno al Tecnológico de Monterrey?</h2>
                                <span>
                                    No, lamentablemente, el evento está limitado a estudiantes del Tecnológico de Monterrey de los campus: CEM, CCM y CSF.
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 border-bottom py-5" data-aos="fade" data-aos-delay="500">
                        <div class="row align-items-stretch">
                            <div class="col-md-12">
                                <h2 class="text-white">¿Es por equipos?</h2>
                                <span>
                                    Sí, de tres personas máximo, pero también se puede participar individualmente*. <br>
                                    *se podrán formar equipos el día del evento.
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 border-bottom py-5" data-aos="fade" data-aos-delay="800">
                        <div class="row align-items-stretch">
                            <div class="col-md-12">
                                <h2 class="text-white">¿Qué ramas/clasificaciones habrá?</h2>
                                <span>
                                    Principiantes y Avanzados. <br>
                                    La primera rama está diseñada para estudiantes de primer semestre hasta tercero, avanzados será para cuarto en adelante.
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 border-bottom py-5" data-aos="fade" data-aos-delay="900">
                        <div class="row align-items-stretch">
                            <div class="col-md-12">
                                <h2 class="text-white">¿Qué plataforma se usará?</h2>
                                <span>
                                    OmegaUp, es recomendable crearse una cuenta para el registro.
                                </span>
                            </div>
                        </div>
                    </div>

                    <div class="col-12 border-bottom py-5" data-aos="fade" data-aos-delay="1000">
                        <div class="row align-items-stretch">
                            <div class="col-md-12">
                                <h2 class="text-white">¿Qué lenguajes de programación están aceptados?</h2>
                                <span>
                                    C++11, C++, C#, C, Haskell, Java, Pascal, Python, Ruby y Lua.
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mb-5">
            <div class="col-md-6 col-lg-4 mb-5 mb-lg-5 blog-entry" data-aos="fade-up" data-aos-delay="200">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus error deleniti dolores necessitatibus
                    eligendi. Nesciunt repellendus ab voluptatibus.
            </div>
