	...
	<div class="container">
		...
		<div class="row align-items-center speaker">
			<div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
				<img src="images/icpc-logo.png" alt="Image" class="img-fluid">
			</div>
			<div class="col-lg-6 ml-auto">
				<h2 class="text-white mb-4 name" data-aos="fade-right" data-aos-delay="200">Programación Competitiva</h2>
				<div class="bio pl-lg-5">
					<span class="text-uppercase text-primary d-block mb-3" data-aos="fade-right" data-aos-delay="300">Introducción básica</span>
					<p class="mb-4" data-aos="fade-right" data-aos-delay="400">Aprende sobre la programación competitiva, los jueces y cómo se manejan estos concursos.</p>
					<p data-aos="fade-right" data-aos-delay="500">
						Síguenos &mdash;
						<a href="https://www.facebook.com/aesc.cem/" class="p-2"><span class="icon-facebook"></span></a>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row" data-aos="fade-up" data-aos-delay="500">
				<div class="col-12 text-center">
					<a href="#" class="btn-custom" data-aos="fade-up" data-aos-delay="400"><span>Más noticias</span></a>
				</div>
			</div>
		</div>
	</div>
